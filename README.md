...
Каких то дополнительных прав - не выдавал.


По результатам работы скрипта:
Все пользователи которые есть в ад в указанных группах попадут в rgsec + подтянутся их фотографии, создадутся ключи доступа и пользователи будут добавлены в группы доступа(в каждую в которой они будут найдены) на сервере rusguard
